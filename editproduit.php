...
<div id="menu-toggle" class="menu-toggle">
    ...
    <main>
        ...
        ?></h1>
            <h3>Name</h3> <input type="text" name="nom" value="<?php echo $row["nom"]?>">
            <h3>Description</h3> <textarea name="description" rows="5" cols="50"> <?php echo $row["description"]?></textarea>
            <h3>Price</h3><input type="text" name="prix" value="<?php echo $row["prix"]?>">
            <h3>quantity</h3> <input type="text" name="quantite" value="<?php echo $row["quantite"]?>">
